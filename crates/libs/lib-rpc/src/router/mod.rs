...
impl RpcRouter {
    ...
    ///
    /// ```
    /// RpcRouter::new().add_dyn("method_name", my_handeler_fn.into_dyn());
    /// ```
    ///
    ...
    ///
    /// ```
    /// RpcRouter::new().add("method_name", my_handler_function)
    /// ```
    ///
    /// Note:   This is a convinient add function variant with generics,
    ...
    pub fn extends(mut self, other_routes: RpcRouter) -> Self {
        self.route_by_name.extend(other_routes.route_by_name);
        self
    }

...
/// (e.g., cid, ctime, mid, mtime will be updated with the same values)
...
/// Update the timestamps info for update
/// (e.g., only mid, mtime will be updated with the same values)
